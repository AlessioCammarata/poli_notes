...
#define filein "partita0.txt"
#define fileout "partita1.txt"
...
- si accetta una tabella più piccola del previsto (le dimensioni sono calcolate
al momento dell'input (servono quindi parametri aggiuntivi per le dimensioni effettive)
- si accetta un comando per sospendere la partita e si scrive su un secondo file
...
Un approccio analogo e' utilizzato per rappresentare una direzione: viene utilizzata una struct
