...
void menuParola(tabella_t tab, comando_e cmd);
...
int main(void) {
  ...
  do {
    cmd = leggiComando(comandi);
		switch(cmd) {
			case r_date:
        menuParola(tab, r_date);
				break;
			case r_partenza:
        menuParola(tab, r_partenza);
				break;
			case r_capolinea:
        menuParola(tab, r_capolinea);
				break;
			case r_ritardo:
        menuParola(tab, r_ritardo);
				break;
			case r_ritardo_tot:
        menuParola(tab, r_ritardo_tot);
				break;
			case r_fine:
				continua = 0;
				break;
